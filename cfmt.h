...
#define TYPE_ID_9(v, ...)  TYPE_ID(v), TYPE_ID_8(__VA_ARGS__)
#define TYPE_ID_8(v, ...)  TYPE_ID(v), TYPE_ID_7(__VA_ARGS__)
#define TYPE_ID_7(v, ...)  TYPE_ID(v), TYPE_ID_6(__VA_ARGS__)
#define TYPE_ID_6(v, ...)  TYPE_ID(v), TYPE_ID_5(__VA_ARGS__)
#define TYPE_ID_5(v, ...)  TYPE_ID(v), TYPE_ID_4(__VA_ARGS__)
