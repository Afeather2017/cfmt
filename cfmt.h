...
#ifdef __cplusplus
// clang-format off
inline int to_type_id(char                 arg) { return 0u; }
inline int to_type_id(unsigned char        arg) { return 1u; }
inline int to_type_id(short                arg) { return 2u; }
inline int to_type_id(unsigned short       arg) { return 3u; }
inline int to_type_id(int                  arg) { return 4u; }
inline int to_type_id(unsigned int         arg) { return 5u; }
inline int to_type_id(long                 arg) { return 6u; }
inline int to_type_id(unsigned long        arg) { return 7u; }
inline int to_type_id(long long            arg) { return 8u; }
inline int to_type_id(unsigned long long   arg) { return 9u; }
inline int to_type_id(float                arg) { return 10; }
inline int to_type_id(double               arg) { return 11; }

inline int to_type_id(const char          *arg) { return 50; }
inline int to_type_id(const unsigned char *arg) { return 51; }
inline int to_type_id(short               *arg) { return 52; }
inline int to_type_id(unsigned short      *arg) { return 53; }
inline int to_type_id(int                 *arg) { return 54; }
inline int to_type_id(unsigned int        *arg) { return 55; }
inline int to_type_id(long                *arg) { return 56; }
inline int to_type_id(unsigned long       *arg) { return 57; }
inline int to_type_id(long long           *arg) { return 58; }
inline int to_type_id(unsigned long long  *arg) { return 59; }
inline int to_type_id(float               *arg) { return 50; }
inline int to_type_id(double              *arg) { return 51; }
// clang-format on
